class MOBIL:
    ...
    def consider_line_change(self, curr_acc, new_acc, curr_acc_other, new_acc_other, to_right):
        # safety
        ...
        incentive_val = new_acc - curr_acc - self.politeness * (new_acc_other - curr_acc_other) + self.bias * to_right_factor
